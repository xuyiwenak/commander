...
const ICP_PSB_LINK =
  "https://beian.mps.gov.cn/#/query/webSearch?code=11010502061608";
    ...
    <>
      ...
      <div style={PAGE_STYLE}>
        ...
        <section style={SECTION_STYLE}>
          <p style={LABEL_STYLE}>StarrySpark Products</p>
          <h2 style={SECTION_TITLE_STYLE}>探索我们的产品</h2>

          <div style={GRID_STYLE}>
            <ProductCard
              accent="#c8529a"
              nameEn="ORIGINAL SENSE"
              nameCn="原色有感"
              adminUrl={MANDIS_WEB_URL}
              actionLabel="开始艺术解读"
              desc="将此刻的感受留在画里，获得一份私密、温柔的 AI 艺术疗愈解读。"
              icon={
                <svg
                  width="22"
                  height="22"
                  ...
                  aria-hidden="true"
                >
                  <path d="M4 17.5A7.5 7.5 0 0 1 12.5 5c2.2 0 4.2.94 5.58 2.44A5.5 5.5 0 1 1 18 18H8.5A4.5 4.5 0 0 1 4 13.5" />
                  <path d="M8 15c1.5-3.5 4-5.5 8-6" />
                </svg>
              }
            />
            <ProductCard
        ...
        <footer style={FOOTER_STYLE}>
          <div style={{ fontSize: 12, color: "#4a5168", lineHeight: 1.9 }}>
            <div>
              © {new Date().getFullYear()} {COMPANY_CN}
            </div>
          ...
          <div style={FOOTER_RECORDS_STYLE}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              style={FOOTER_BEIAN_LINK_STYLE}
            >
              <img
                src={beianIcon}
                alt=""
                aria-hidden="true"
                style={FOOTER_BEIAN_ICON_STYLE}
              />
